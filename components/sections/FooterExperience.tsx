      ...
      <div className="r-ft" style={{ maxWidth: 1240, margin: '0 auto', gap: 40, paddingBottom: 40, borderBottom: '1px solid var(--line)' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 11, fontSize: 14.5 }}>
            {([['/', 'Home'], ['/about', 'Who We Are'], ['/leadership', 'Leadership'], ['/ministries', 'Ministries'], ['/online', 'Online'], ['/giving', 'Giving'], ['/devotional', 'Devotional'], ['/events', 'Events'], ['/calendar', 'Calendar'], ['/visit', 'Visit'], ['/contact', 'Contact']] as const).map(([href, label]) => (
