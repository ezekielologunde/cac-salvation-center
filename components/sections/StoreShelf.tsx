...
import { Shirt, BookOpen, Music2, Printer, ShoppingBag, Star, ExternalLink, Mail, Plus, Check } from "lucide-react";
        ...
        {CATEGORIES.map((c) => (
          <button
            ...
            style={{
              ...
              boxShadow: active === c.key ? "0 8px 20px rgba(27,19,14,.22)" : "0 2px 8px rgba(27,19,14,.08)",
              border: "1px solid",
